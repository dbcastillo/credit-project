...
class CreditsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit" do
    assert_difference('Credit.count') do
      post credits_url, params: { credit: { apr: @credit.apr, limit: @credit.limit, username: @credit.username } }
    end
  ...
  test "should update credit" do
    patch credit_url(@credit), params: { credit: { apr: @credit.apr, limit: @credit.limit, username: @credit.username } }
